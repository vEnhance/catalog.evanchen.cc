...
+++
## Philosophy
This unit is really about taking a holistic view of a problem, contrasting with [Local](wiki:local). You're usually given a structure, where you need to count something, be it giving a contradiction using Pigeonhole or finding a lower bound. 
...
## Notable Problems
* [2006 ISL C3](https://aops.com/community/p874985): Demonstrates the large power EV can have, even on olympiad problems. 
* [IMO 2005/6](https://aops.com/community/p282141): A classic global problem. 
* [2010 ISL C5](https://aops.com/community/p2362302): An instructive problem on ways to characterize certain states in order to form a sum.
