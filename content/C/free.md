...
unit).'''
+++
This lecture discusses the other extreme to the [Rigid](wiki:Rigid) one: the problem gives you lots of freedom. It’s impossible in these cases to try and understand the structure completely, but the problem will ask you only to do a small part of it (e.g. an existence proof). Often you have to impose the structure yourself so that you have something to work with. 
...
* [2015 TSTST/6](https://aops.com/community/p5017871): A walkthrough with a construction that seems contrived at first.

* [Shortlist 2010 C1](https://aops.com/community/p2362292): A required 9 clubs problem. This problem represents how you can add restrictions to make finding a construction easier.

* [USAMO 2014/3](https://aops.com/community/p3477763): Demonstrates how one should choose the easiest constructions.
