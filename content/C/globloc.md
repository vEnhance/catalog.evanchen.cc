...
You will have a much easier time if you have done either of [Local](wiki:local)
or [Global](wiki:global) before, preferably both.
...
I hope that you enjoy this unit and learn from it as much as I did :).
...
Global: This is all about examining the whole problem structure (which usually
...
More details at [Global] (wiki:global) and in the unit.
...
1. [2020 Cyberspace P7](https://aops.com/community/p16433037):
   This problem has both a global and a local solution. Which one shalt thou find first?

2. [2005 IMO 6](https://aops.com/community/p282141): This problem emphasizes the (Guess what?) strategy,
   and solving this means you have understood how to apply it well.

3. [2013 ISL C4](https://aops.com/community/p3543403): A very unexpected problem,
   with which neither philosophy works particularly well at first glance. One triumphs though.

4. [2014 IMO 6](https://aops.com/community/p3543151): This problem emphasizes the (Guess what?) strategy,
   and solving this means you have understood how to apply it well. Required on ZCX.

5. [2008 USAMO 3](https://aops.com/community/p1116367): This solution admits solutions using either approach,
   both of which are tricky to find. Doing this problem is highly recommended.

6. [2006 ISL C3](https://aops.com/community/p874985): A real shocker of a problem.
   Prepare to be wowed away when you stumble into the solution.
