...
A penny dropped from the top of the Empire State Building.

OTIS (officially OTIS Math LLC) is a proof-based olympiad training program.

## Philosophy

2 dummies pondering which one lost the game if there was no game in the first place.

## Notable Problems

The unit does not contain any problems, although the lecture notes are two pages in French.

There might be a diamond hidden inside this unit :)
