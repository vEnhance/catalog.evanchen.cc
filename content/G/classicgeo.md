...
+++
## Philosophy
American Geo splits up into two parts: Classical and [Config Geo](https://otis.evanchen.cc/wiki/units/list-of-geometry-units/config-geo/). While Config Geo relies more on recognizing common configs that appear in many problems, Classical is more about constructing the config yourself, by adding lines or circles to the diagram and slowly getting more information about the config. Thus, Classical may be more challenging than its Config counterpart.
...
* [TSTST 2021/1](https://aops.com/community/p23586650): An easier problem that demonstrates the idea of adding new points into a config.

* [Sharygin 2009 Finals](https://aops.com/community/p10711892): A 9-pointer problem that represents what Classical is like, where you will need to construct points that slowly give you more information.
