...
- Jensen / Karamata / tangent line trick / <span class="math math-inline">n-1</span> EV (functional approaches);
...
- [Bulgaria 2018/3](https://aops.com/community/p10202343): An iconic and unconventional required problem, which took Evan almost 2 hours on stream.

## Recommendations


This is fairly easy for a Z-level unit, especially if you’ve done a lot of inequalities before. This should be unlocked after completing its [standard](https://otis.evanchen.cc/wiki/units/list-of-algebra-units/ineq-standard/) (or [basic](https://otis.evanchen.cc/wiki/units/list-of-algebra-units/ineq-basic/)) and [functional](https://otis.evanchen.cc/wiki/units/list-of-algebra-units/ineq-func/) counterparts, since the techniques developed in those units become common knowledge here. 
