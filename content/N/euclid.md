...
1. Subtract a multiple of <span class="math math-inline">A</span> from <span class="math math-inline">B</span>, and divisibility still holds
2. Throw out factors of <span class="math math-inline">B</span> that are coprime with <span class="math math-inline">A</span>, and divisibility still holds.
3. If we end up with a situation where |RHS|<|LHS|, deduce that |RHS|=0.

In many number theory problems, this technique is useful. Evan calls it "remainder bounding", because we want to take the remainder of <span class="math math-inline">B</span> mod <span class="math math-inline">A</span> and compare it with <span class="math math-inline">A</span>. 
...
* [Shortlist 2013 N1](https://aops.com/community/p3544096): An easier problem from which beginners can understand remainder bounding.
* [Shortlist 2016 N6](https://aops.com/community/p8639255): This one is a nice ego booster.
* [Shortlist 2004 N3](https://aops.com/community/p169519): A typical FE where remainder bounding is a necessary technique.



Non-FE problems

 * [HMMT 2017 A4](https://aops.com/community/p7710425): A nice problem from HMMT that demonstrates this philosophy well.
